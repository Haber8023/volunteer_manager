...
public interface VolunteerMapper {
	...
	public List<Volunteer> get_CQU_volunteer_with_hours_by_Date_DESC(@Param("startDate")String startDate, @Param("stopDate")String stopDate, @Param("school")String school);
