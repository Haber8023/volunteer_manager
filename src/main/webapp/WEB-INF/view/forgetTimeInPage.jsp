	...
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			...
			<ul class="list-unstyled">
				...
				<li ><a href="timeInPage"> <i
						class="icon-check"></i>时长录入
				</a></li>
				<li class="active"><a href="forgetTimeInPage"> <i
					...
					<blockquote class="layui-elem-quote">
						...
						<div class="panel-body" style="padding-bottom: 0px;">
							<form class="form-horizontal" name="inputForm "
								action="forgetTimeInFinder" onsubmit="return validateForm()"
								method="post">
  ...
  -->
					...
					<center>
						<li>共<i class="blue">${pageInfo.total}</i>条记录，当前显示第<i
							...
							<a
							href="${pageContext.request.contextPath}/forgetTimeInPage?currentPage=1"><button
									class="layui-btn layui-btn-normal  layui-btn-sm">首页</button></a> <c:if
								test="${pageInfo.hasPreviousPage }">
								<a
									href="${pageContext.request.contextPath}/forgetTimeInPage?currentPage=${pageInfo.pageNum-1}"><button
							...
							href="${pageContext.request.contextPath}/forgetTimeInPage?currentPage=${pageInfo.pages}"><button>
									末页</button></a>
						</li>
					</center>
					<div class="cxbottom">
	...
	<div class="modal fade" id="halfDayInModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form name="halfDayInForm" id="halfDayInForm" action="forgetHalfDayIn"
	...
	<div class="modal fade" id="allDayInModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form name="allDayInForm" id="allDayInForm" action="forgetAllDayIn"
					...
					<div class="modal-body">
						...
						服务内容： <input id="record_detail_all"  type="text"
							name="record_detail_all" >
															...
															<div class="modal-body">
						服务日期： <input id="date_all"  type="text"
							name="date_all"  placeholder="如:2019-01-01" autocomplete="off">
					</div>
					<div class="modal-footer">
						<button type="submit" class="btn btn-success">提交</button>
					</div>
