...
<li><a href="schoolPage"> <i class="icon-page"></i>单位年统计
				</a></li>					<li class="active"><a href="schoolMonthPage"> <i class="icon-page"></i>单位月统计
				</a></li>
			</ul>
			</nav>
					...
					<blockquote class="layui-elem-quote">
						...
						<div class="panel-body" style="padding-bottom: 0px;">
							<form class="form-horizontal" id="inputForm" name="inputForm "
								action="schoolMonthFinder" onsubmit="return validateForm()"
								method="post">	
											<center>
											...
											<td width="21%">
												<div class="" id="data_5">
													<div class="input-daterange input-group" id="datepicker">
														<input type="text" placeholder="如：2020-01" value="${monthDate}"
															value="${monthDate}" class="form-control"
															style="border-radius: 3px; height: 30px" id="monthDate"
															name="monthDate"></input>
													</div>
												</div>
											</td>
											<th width="12%">单位名称：</th>
					...
					<div id="content" style="width: 100%; height: 533px;">
						...
						<table class="table table-hover table-bordered" id="tables"
							...
							data-side-pagination="client" style="border: 1px solid black">
							   <caption>${monthDate}${unit}志愿者服务时长统计情况</caption>
							<thead>
								<tr>
									<th>志愿者编号</th>
									<th>志愿者姓名</th>
...
<tr>
<th rowspan="3"  colspan="5" >备注：服务时长4小时代表半天，服务时长8小时代表全天。按服务时长由高到低排序。</th>
									<th>本月总计服务时长（/h）</th>
    ...
    var id = "tables",
        worksheetName = 'sheet',
        workName = disname+ unit+"志愿者服务时长统计.xls";
