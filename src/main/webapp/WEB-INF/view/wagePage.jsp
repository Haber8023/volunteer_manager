	...
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			...
			<ul class="list-unstyled">
				...
				<li class="active"><a href="wagePage"> <i class="icon-grid"></i>工资结算
				</a></li>
					...
					<blockquote class="layui-elem-quote">
						...
						<div class="panel-body" style="padding-bottom: 0px;">
							<form class="form-horizontal" id="inputForm" name="inputForm "
								action="wageFinder" onsubmit="return validateForm()"
								method="post">	
											<center>
											<h2>结算年月：</h2>
											<input type="text"
												placeholder="格式：YYYY-MM，如：2019-01" value="${wageDate}"
												class="form-control"
												style="border-radius: 3px; height: 45px ;width: 300px" id="wageDate" name="wageDate">
																			<h3>&ensp;</h3>
									<div class="cxbottom">
											<button type="submit" >生成工资单</button>
    ...
    <input id="button" type="button" value="导出为Excel表格">
					...
					<div id="content" style="width: 100%; height: 533px;">
						...
						<table class="table table-hover table-bordered" id="tables"
							...
							<caption>${wageDate}社会志愿者应发工资表</caption>	
							<thead>
								<tr>
									<th>志愿者编号</th>
									<th>志愿者姓名</th>
...
<tr>
<th rowspan="2"  colspan="6">备注：服务时长4小时代表半天，服务时长8小时代表全天。服务半天应发放15元，服务全天应发放30元。</th>
    ...
    <script>
		function validateForm() {
			var Date = document.forms["inputForm"]["wageDate"].value;
